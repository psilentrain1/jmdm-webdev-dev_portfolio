            ...
            <div className={styles.home__page}>
              ...
              <div className={styles.home__content}>
                ...
                <section className={styles.home__about}>
                  ...
                  <p>
                    Hey! I&apos;m a software developer who brings creativity from multiple worlds into my code. With experience in both
                    desktop and web development, I bridge the gap between robust local applications and modern web experiences.
                  </p>
