...
export default function PrivacyPolicy() {
  const contactEmail = "james@jamesdraketech.com";
  ...
  return (
    <>
      <div className={styles.privacy}>
        ...
        <p>
          This privacy notice for James Drake (doing business as James M. Drake Media and/or 12Gates Films & Services) (“Company,” “we,”
          “us,” “our,“ or &ldquo;I&rdquo;), describes how and why we might collect, store, use, and/or share (“process“) your information
        ...
        <p>
          <strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If
          you do not agree with the terms of this privacy notice, please do not use our Services. If you still have any questions or
          concerns, please contact us at {contactEmail}.
        </p>
        <p>
          This privacy policy was adapted from Termly&apos;s{" "}
        ...
        <p>
          ...
          When you visit, use, or navigate our Services, we may process personal information depending on how you interact with the Website
        ...
        <p>
          <strong>Do you receive any information from third parties? </strong>We may receive information from public databases, marketing
          partners, social media platforms, and other outside sources.
        </p>
        <p>
          <strong>How do you process my information? </strong>We process your information to provide, improve, and administer our Services,
        ...
        <p>
          <strong>In what situations and with which types of parties do we share personal information? </strong>We may share information in
          specific situations and with specific categories of third parties.
        </p>
        <p>
          <strong>How do we keep your information safe? </strong>We have organizational and technical processes and procedures in place to
          ...
          guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties
        ...
        <p>
          ...
          have certain rights regarding your personal information. Want to learn more about what [Company Name] does with any information we
          collect? Review the notice in full below.
        </p>
        <p>
          <strong>How do I exercise my rights? </strong>The easiest way to exercise your rights is by contacting us. We will consider and
          act upon any request in accordance with applicable data protection laws.
        </p>
        <p>Want to learn more about what we do with any information we collect? Review the notice in full below.</p>
        ...
        <ol>
          ...
          <li>
            <a href="#legal-bases">WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</a>
          </li>
          <li>
            <a href="#share-information">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a>
          </li>
          <li>
            <a href="#third-party">WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</a>
          </li>
          <li>
          ...
          <li>
            <a href="#transferred-internationally">IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</a>
          </li>
          <li>
            <a href="#how-long">HOW LONG DO WE KEEP YOUR INFORMATION?</a>
          </li>
          <li>
          ...
          <li>
            <a href="#review-data">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a>
          </li>
        </ol>
        <h3 id="what-information">1. WHAT INFORMATION DO WE COLLECT?</h3>
        <p>
        ...
        <ul>
          ...
          <li>Email address</li>
          <li>Phone number</li>
          <li>Any other personal information provided by you to complete the rendering of any Service.</li>
        </ul>
        <p>
          <strong>Sensitive Information. </strong>We do not process sensitive information.
        </p>
        <p>
          <strong>Payment Data. </strong>We may collect data necessary to process your payment if you make purchases or enter contracts for
          services, such as your payment instrument number (such as a credit card number), and the security code associated with your
          payment instrument. All payment data is stored by the payment vendor. You may find their privacy notice link(s) on their
          individual websites.
        </p>
        <p>
          ...
          account details, like your Facebook, Twitter/X, or other social media account. If you choose to register in this way, we will
          collect the information described in the section called “<a href="#social-logins">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a>” below.
        </p>
        <p>
        ...
        <p>We do not collect information through cookies or similar technologies.</p>
        <p>The information we collect includes:</p>
        <ul>
          <li>
            <em>Log and Usage Data. </em>Log and usage data is service-related, diagnostic, usage, and performance information our servers
          ...
          <li>
            <em>Device Data. </em>We collect device data such as information about your computer, phone, tablet, or other device you use to
            access the Services. Depending on the device used, this device data may include information such as your IP address (or proxy
            server), device and application identification numbers, location, browser type, hardware model, Internet service provider and/or
            mobile carrier, operating system, and system configuration information.
          </li>
          <li>
            <em>Location Data. </em>We collect location data such as information about your device’s location, which can be either precise
            or imprecise. How much information we collect depends on the type and settings of the device you use to access the Services. For
        ...
        <p>
          ...
          information about you from other sources, such as public databases, joint marketing partners, affiliate programs, data providers,
          social media platforms, and from other third parties. This information includes mailing addresses, job titles, email addresses,
          phone numbers, intent data (or user behavior data), Internet Protocol (IP) addresses, social media profiles, social media URLs,
          and custom profiles, for purposes of targeted advertising and event promotion. If you interact with us on a social media platform
          using your social media account (e.g., Facebook or Twitter/X), we receive personal information about you such as your name, email
          address, and gender. Any personal information that we collect from your social media account depends on your social media
          account’s privacy settings.
        </p>
        <h3 id="process-information">2. HOW DO WE PROCESS YOUR INFORMATION?</h3>
        <p>
          <strong>In Short: </strong>We process your information to provide, improve, and administer our Services, communicate with you, for
        ...
        <ul>
          ...
          <li>
            <strong>To deliver and facilitate delivery of services to the user. </strong>We may process your information to provide you with
          ...
          <li>
            <strong>To fulfill and manage your orders. </strong>We may process your information to fulfill and manage your orders, payments,
            returns, and exchanges made through the Services.
          </li>
          <li>
            <strong>To enable user-to-user communications. </strong>We may process your information if you choose to use any of our
          ...
          <li>
            ...
            for our marketing purposes, if this is in accordance with your marketing preferences. You can opt out of our marketing emails at
            any time. For more information, see “<a href="#privacy-rights">WHAT ARE YOUR PRIVACY RIGHTS?</a>” below.
          </li>
          <li>
            <strong>To deliver targeted advertising to you. </strong>We may process your information to develop and display personalized
          ...
          <li>
            <strong>To determine the effectiveness of our marketing and promotional campaigns. </strong>We may process your information to
            better understand how to provide marketing and promotional campaigns that are most relevant to you.
          </li>
          <li>
            <strong>To save or protect an individual’s vital interest. </strong>We may process your information when necessary to save or
            protect an individual’s vital interest, such as to prevent harm.
          </li>
        </ul>
        <h3 id="legal-bases">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h3>
        <p>
        ...
        <p className={styles.locatedin}>If you are located in the EU or UK, this section applies to you.</p>
        <p>
        ...
        <ul>
          ...
          <li>
            <strong>Performance of a Contract. </strong>We may process your personal information when we believe it is necessary to fulfill
            our contractual obligations to you, including providing our Services or at your request prior to entering into a contract with
            you.
          </li>
          <li>
            <strong>Legitimate Interests. </strong>We may process your information when we believe it is reasonably necessary to achieve our
        ...
        <p>
          ...
          in this privacy notice, since we determine the means and/or purposes of the data processing we perform. This privacy notice does
          not apply to the personal information we process as a “data processor” on behalf of our customers. In those situations, the
          customer that we provide services to and with whom we have entered into a data processing agreement is the “data controller”
        ...
        <p className={styles.locatedin}>If you are located in Canada, this section applies to you.</p>
        <p>
        ...
        <h3 id="share-information">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h3>
        <p>
        ...
        <p>
          ...
          service providers, contractors, or agents (“<strong>third parties</strong>”) who perform services for us or on our behalf and
          require access to such information to do that work. We have contracts in place with our third parties, which are designed to help
          ...
          instructed them to do it. They will also not share your personal information with any organization apart from us. They also commit
          to protect the data they hold on our behalf and to retain it for the period we instruct. The categories of third parties we may
        ...
        <ul>
          ...
          <li>
            ...
            to honor this privacy notice. Affiliates include our parent company and any subsidiaries, joint venture partners, or other
          ...
          <li>
            <strong>Other Users. </strong>When you share personal information (for example, by posting comments, contributions, or other
            content to the Services) or otherwise interact with public areas of the Services, such personal information may be viewed by all
            users and may be publicly made available outside the Services in perpetuity. If you interact with other users of our Services
            and register for our Services through a social network (such as Facebook), your contacts on the social network will see your
            name, profile photo, and descriptions of your activity. Similarly, other users will be able to view descriptions of your
          ...
          <li>
            ...
            third-party advertisers to offer virtual currency, gifts, or other items to users in return for the acceptance and completion of
            an advertisement offer. Such an offer wall may appear in our application(s) and be displayed to you based on certain data, such
            as your geographic area or demographic information. When you click on an offer wall, you will be brought to an external website
        ...
        <h3 id="third-party">5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h3>
        <p>
          <strong>In Short: </strong>We are not responsible for the safety of any information that you share with third parties that we may
          link to or who advertise on our Services, but are not affiliated with, our Services.
        </p>
        <p>
          The Services may link to third-party websites, online services, or mobile applications and/or contain advertisements from third
          parties that are not affiliated with us and which may link to other websites, services, or applications. Accordingly, we do not
          make any guarantee regarding any such third parties, and we will not be liable for any loss or damage caused by the use of such
          third-party websites, services, or applications. The inclusion of a link towards a third-party website, service, or application
          does not imply an endorsement by us. We cannot guarantee the safety and privacy of data you provide to any third parties. Any data
        ...
        <p>
          <strong>In Short: </strong>We do not use cookies, but we may use other tracking technologies to collect and store your
          information.
        </p>
        <p>We may use tracking technologies (like web beacons and pixels) to access or store information.</p>
        <h3 id="social-logins">7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h3>
        <p>
          <strong>In Short: </strong>If you choose to register or log in to our services using a social media account, we may have access to
        ...
        <p>
          ...
          or Twitter/X logins). Where you choose to do this, we will receive certain profile information about you from your social media
          ...
          social media platform. If you log in using Facebook, we may also request access to other permissions related to your account, such
          as your friends, check-ins, and likes, and you may choose to grant or deny us access to each individual permission.
        </p>
        <p>
        ...
        <h3 id="transferred-internationally">8. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h3>
        <p>
          <strong>In Short: </strong>We may transfer, store, and process your information in countries other than your own.
        </p>
        <p>
          Our servers are located in the United States. If you are accessing our Services from outside the United States, please be aware
          that your information may be transferred to, stored, and processed by us in our facilities and by those third parties with whom we
          may share your personal information (see “
          <a href="#share-information">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a>” above), and other countries.
        </p>
        <p>
          If you are a resident in the European Economic Area (EEA) or United Kingdom (UK), then these countries may not necessarily have
          data protection laws or other similar laws as comprehensive as those in your country. However, we will take all necessary measures
          to protect your personal information in accordance with this privacy notice and applicable law.
        </p>
        <h3 id="how-long">9. HOW LONG DO WE KEEP YOUR INFORMATION?</h3>
        <p>
        ...
        <p>
          ...
          this notice will require us keeping your personal information for longer than the period of time in which users have an account
          with us.
        </p>
        <p>
        ...
        <h3 id="safety">10. HOW DO WE KEEP YOUR INFORMATION SAFE?</h3>
        <p>
        ...
        <h3 id="minors">11. DO WE COLLECT INFORMATION FROM MINORS?</h3>
        <p>
        ...
        <p>
          ...
          are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services.
          ...
          children under age 18, please contact us at {contactEmail}.
        </p>
        <h3 id="privacy-rights">12. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
        <p>
          <strong>In Short: </strong>In some regions, such as the European Economic Area (EEA), United Kingdom (UK), and Canada, you have
        ...
        <p>
          ...
          <a href="https://edpb.europa.eu/about-edpb/about-edpb/members_en">https://edpb.europa.eu/about-edpb/about-edpb/members_en</a>.
        </p>
        <p>
        ...
        <p>
          <span className={styles.ulbold}>Withdrawing your consent:</span> If we are relying on your consent to process your personal
          ...
          section “<a href="#contact">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a>” below or updating your preferences.
        </p>
        <p>
        ...
        <p>
          <span className={styles.ulbold}>Opting out of marketing and promotional communications:</span> You can unsubscribe from our
          ...
          “STOP” or “UNSUBSCRIBE” to the SMS messages that we send, [Other] or by contacting us using the details provided in the section “
          <a href="#contact">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a>” below. You will then be removed from the marketing lists —
        ...
        <p>
          <span className={styles.ulbold}>Cookies and similar technologies:</span> Most Web browsers are set to accept cookies by default.
          ...
          or reject cookies, this could affect certain features or services of our Services. To opt out of interest-based advertising by
          advertisers on our Services visit http://www.aboutads.info/choices/.
        </p>
        <p>If you have questions or comments about your privacy rights, you may email us at {contactEmail}.</p>
        <h3 id="do-not-track">13. CONTROLS FOR DO-NOT-TRACK FEATURES</h3>
        <p>
        ...
        <h3 id="california">14. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h3>
        <p>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Account login information, drivers’ licenses, health data, precise geolocation, racial or ethnic origin, religious or
        ...
        <p>We will use and retain the collected personal information as needed to provide the Services.</p>
        <p>
        ...
        <ul>
          ...
          <li>
            Social media plugins: We use social media features, such as a “Like” button, and widgets, such as a “Share” button in our
            Services. Such features may process your Internet Protocol (IP) address and track which page you are visiting on our website. We
            may place a cookie to enable the feature to work correctly. If you are logged in on a certain social media platform and you
            interact with a widget or button belonging to that social media platform, this information may be recorded to your profile of
            such social media platform. To avoid this, you should log out from that social media platform before accessing or using the
            Services. Social media features and widgets may be hosted by a third party or hosted directly on our Services. Your interactions
            with these features are governed by the privacy notices of the companies that provide them. By clicking on one of these buttons,
            you agree to the use of this plugin and consequently the transfer of personal information to the corresponding social media
            service. We have no control over the essence and extent of these transmitted data or their additional processing.
          </li>
        </ul>
        <p>More information about our data collection and sharing practices can be found in this privacy notice.</p>
        <p>You may contact us by email at {contactEmail}, or by referring to the contact details at the bottom of this document.</p>
        <p>
        ...
        <p>
          ...
          provider. Each service provider is a for-profit entity that processes the information on our behalf, following the same strict
        ...
        <p>
          We have disclosed the following categories of personal information to third parties for a business or commercial purpose in the
        ...
        <ul>
          ...
          <li>
            Category D. Commercial information, such as transaction information, purchase history, financial details, and payment
            information.
          </li>
          <li>
        ...
        <p>
          We have not sold or shared any personal information to third parties for a business or commercial purpose in the preceding twelve
          (12) months.
        </p>
        <p>
          <strong>Your rights with respect to your personal data</strong>
        </p>
        <p className={styles.ul}>Right to request deletion of the data — Request to delete</p>
        <p>
        ...
        <p className={styles.ul}>Right to be informed — Request to know</p>
        ...
        <p className={styles.ul}>Right to Non-Discrimination for the Exercise of a Consumer’s Privacy Rights</p>
        <p>We will not discriminate against you if you exercise your privacy rights.</p>
        <p className={styles.ul}>Right to Limit Use and Disclosure of Sensitive Personal Information</p>
        <p>We do not process consumer’s sensitive personal information.</p>
        <p className={styles.ul}>Verification process</p>
        <p>
        ...
        <p className={styles.ul}>Other privacy rights</p>
        <ul>
        ...
        <p>
          To exercise these rights, you can contact us by email at {contactEmail}, or by referring to the contact details at the bottom of
        ...
        <p>
          “Financial incentive” means a program, benefit, or other offering, including payments to consumers as compensation, for the
          disclosure, deletion, sharing, or sale of personal information.
        </p>
        <p>
          The law permits financial incentives or a price or service difference if it is reasonably related to the value of the consumer’s
          data. A business must be able to explain how the financial incentive or price or service difference is reasonably related to the
          value of the consumer’s data. The explanation must include:
        </p>
        <ul>
          <li>
            a good-faith estimate of the value of the consumer’s data that forms the basis for offering the financial incentive or price or
            service difference; and
          </li>
          <li>a description of the method the business used to calculate the value of the consumer’s data.</li>
        </ul>
        <p>
          We may decide to offer a financial incentive (e.g., price or service difference) in exchange for the retention, sale or sharing of
          a consumer’s personal information.
        </p>
        <p>
          If we decide to offer a financial incentive, we will notify you of such financial incentive and explain the price difference, as
          well as material terms of the financial incentive or price of service difference, including the categories of personal information
          that are implicated by the financial incentive or price or service difference.
        </p>
        <p>
          If you choose to participate in the financial incentive you can withdraw from the financial incentive at any time by emailing us
          at {contactEmail}, or by referring to the contact details at the bottom of this document.
        </p>
        <h3 id="virginia">15. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h3>
        <p>
          <strong>In Short: </strong>Yes, if you are a resident of Virginia, you may be granted specific rights regarding access to and use
        ...
        <p>
          “Consumer” means a natural person who is a resident of the Commonwealth acting only in an individual or household context. It does
        ...
        <p>
          The information we collect, use, and disclose about you will vary depending on how you interact with us and our Services. To find
          out more, please visit the following sections above:
        </p>
        <ul>
          <li>
            <a href="#what-information">1. WHAT INFORMATION DO WE COLLECT?</a>
          </li>
          <li>
            <a href="#process-information">2. HOW DO WE PROCESS YOUR INFORMATION?</a>
          </li>
          <li>
            <a href="#share-information">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a>
          </li>
        </ul>
        <p className={styles.ul}>Your rights with respect to your personal data</p>
        <ul>
        ...
        <p>
          We have not sold any personal data to third parties for business or commercial purposes. We will not sell personal data in the
          future belonging to website visitors, users, and other consumers.
        </p>
        <p className={styles.ul}>Exercise your rights provided under the Virginia CDPA</p>
        <p>More information about our data collection and sharing practices can be found in this privacy notice.</p>
        <p>You may contact us by email at {contactEmail}, or by referring to the contact details at the bottom of this document.</p>
        <p>
        ...
        <p className={styles.ul}>Verification process</p>
        <p>
          We may request that you provide additional information reasonably necessary to verify you and your consumer’s request. If you
          submit the request through an authorized agent, we may need to collect additional information to verify your identity before
        ...
        <p className={styles.ul}>Right to appeal</p>
        <p>
          ...
          appeal our decision, please email us at {contactEmail}. Within sixty (60) days of receipt of an appeal, we will inform you in
          writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the
          decisions. If your appeal is denied, you may contact the Attorney General to{" "}
          <a href="https://www.oag.state.va.us/consumer-protection/index.php/file-a-complaint">submit a complaint</a>.
        </p>
        <h3 id="updates">16. DO WE MAKE UPDATES TO THIS NOTICE?</h3>
        <p>
        ...
        <h3 id="contact">17. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h3>
        <p>If you have questions or comments about this notice, you may contact us at {contactEmail}.</p>

        {/* UPDATE THIS ONCE I GET A BUSINESS ADDRESS */}
        ...
        Phone: [Phone Number]
        Fax: [Fax Number] */}
        <h3 id="review-data">18. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>
        <p>
          ...
          information, please email us at {contactEmail}.
        </p>
        {/* Future DSAR form? */}
        {/* please visit: [DSAR Form URL]. */}
      </div>
    </>
  );
}
